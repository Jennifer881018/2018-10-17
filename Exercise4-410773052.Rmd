...
params:
  studentID: "410773052"
  studentName: "應宜蓁"
  repoURL: "https://github.com/Jennifer881018/2018-10-17"
---
...
## 2.1
**allBankData**的**年月**變數為民國年月，請將他改成西元年月日的date class, 「日」請設定成為1號，結果請存回**年月**變數。（hint: 善用`stringr::()`及`lubridate::ymd()`丶`lubridate::years()`）

```{r ans21}
library(stringr)
library(lubridate)
allBankData$年月<-str_c("1" )
allBankData$年月<-ymd()
allBankData$年月<-years()
```
